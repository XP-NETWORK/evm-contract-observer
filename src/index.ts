...
app.listen(config.port || 3100, async () => {
  ...
  runWorker({contract: '0xb8403ffba4d0af0e430b128c5569e335ec00c4c9', timeout: .86, interval: 5 ,name: 'CMC Staking', symbol: 'CMCS', chainId: '20' });
  runWorker({contract: '0xce300b00aa9c066786d609fc96529dbedaa30b76', timeout: .75, interval: 5 ,name: 'IoTeX PUNKS', symbol: 'PUNK', chainId: '20' });
